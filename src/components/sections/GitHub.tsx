...
export function GitHub({ repos }: GitHubSectionProps) {
  ...
  return (
    ...
    >
      {/* Profile Link */}
      <div className="flex items-center gap-4 mb-8 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl">
        <div className="p-3 bg-neutral-900 dark:bg-white rounded-full">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {displayRepos.map((repo, index) => (
          <motion.a
            ...
            className="p-5 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors group"
          >
