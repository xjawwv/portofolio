...
export function SocialIconLink({ name, url, icon }: SocialIconLinkProps) {
  ...
  return (
    <a
      ...
      className="group flex items-center gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
      aria-label={name}
    >
      <div className="p-2 bg-white dark:bg-neutral-700 rounded-lg shadow-sm group-hover:shadow transition-shadow">
